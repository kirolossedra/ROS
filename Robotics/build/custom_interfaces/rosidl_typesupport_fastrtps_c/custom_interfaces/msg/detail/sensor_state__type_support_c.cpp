...
#include "custom_interfaces/msg/detail/sensor_state__rosidl_typesupport_fastrtps_c.h"
...
using _SensorState__ros_msg_type = custom_interfaces__msg__SensorState;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
bool cdr_serialize_custom_interfaces__msg__SensorState(
  const custom_interfaces__msg__SensorState * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
bool cdr_deserialize_custom_interfaces__msg__SensorState(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces__msg__SensorState * ros_message)
{
  // Field name: sensor_name
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__msg__SensorState(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__SensorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__SensorState;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
bool cdr_serialize_key_custom_interfaces__msg__SensorState(
  const custom_interfaces__msg__SensorState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: sensor_name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_key_custom_interfaces__msg__SensorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SensorState__ros_msg_type * ros_message = static_cast<const _SensorState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_key_custom_interfaces__msg__SensorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_interfaces__msg__SensorState * ros_message = static_cast<const custom_interfaces__msg__SensorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_interfaces__msg__SensorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_interfaces__msg__SensorState * ros_message = static_cast<custom_interfaces__msg__SensorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_interfaces__msg__SensorState(cdr, ros_message);
}

static uint32_t _SensorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__SensorState(
...
static size_t _SensorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__SensorState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, SensorState)() {
