...
#include "kiro_custom_interfaces/msg/detail/sensor_state__rosidl_typesupport_fastrtps_c.h"
...
using _SensorState__ros_msg_type = kiro_custom_interfaces__msg__SensorState;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kiro_custom_interfaces__msg__SensorState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const kiro_custom_interfaces__msg__SensorState * ros_message = static_cast<const kiro_custom_interfaces__msg__SensorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_kiro_custom_interfaces__msg__SensorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  kiro_custom_interfaces__msg__SensorState * ros_message = static_cast<kiro_custom_interfaces__msg__SensorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_kiro_custom_interfaces__msg__SensorState(cdr, ros_message);
}

static uint32_t _SensorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kiro_custom_interfaces__msg__SensorState(
...
static size_t _SensorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kiro_custom_interfaces__msg__SensorState(
