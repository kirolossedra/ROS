    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'kiro_custom_interfaces.msg.SensorState')
            logger.debug(
...
class SensorState(metaclass=Metaclass_SensorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.new_readings_ready = kwargs.get('new_readings_ready', bool())
        self.reading_id = kwargs.get('reading_id', int())
    ...
    def __eq__(self, other):
        ...
        if self.sensor_name != other.sensor_name:
            return False
        if self.new_readings_ready != other.new_readings_ready:
            return False
        if self.reading_id != other.reading_id:
            return False
        return True
    ...
    @builtins.property
    def new_readings_ready(self):
        """Message field 'new_readings_ready'."""
        return self._new_readings_ready

    @new_readings_ready.setter
    def new_readings_ready(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'new_readings_ready' field must be of type 'bool'"
        self._new_readings_ready = value

    @builtins.property
    def reading_id(self):
        """Message field 'reading_id'."""
    ...
    def reading_id(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'reading_id' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'reading_id' field must be an integer in [-9223372036854775808, 9223372036854775807]"
