...
{
  new (message_memory) custom_interfaces::msg::SensorState(_init);
}

void SensorState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::SensorState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorState_message_member_array[3] = {
  {
    ...
    offsetof(custom_interfaces::msg::SensorState, sensor_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::SensorState, new_readings_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::SensorState, reading_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorState_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_interfaces::msg::SensorState),
...
get_message_type_support_handle<custom_interfaces::msg::SensorState>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::SensorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, SensorState)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::SensorState_message_type_support_handle;
}
